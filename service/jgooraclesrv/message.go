...
// Create insert data
func (srv *message) Create(data jgooraclemod.Message) (jsql.Result, error) {
...
func (srv *message) CreateTx(agent *jsql.Agent, data jgooraclemod.Message) (jsql.Result, error) {
