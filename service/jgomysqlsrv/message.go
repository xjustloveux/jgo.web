...
// Create insert data
func (srv *message) Create(data jgomysqlmod.Message) (jsql.Result, error) {
...
func (srv *message) CreateTx(agent *jsql.Agent, data jgomysqlmod.Message) (jsql.Result, error) {
